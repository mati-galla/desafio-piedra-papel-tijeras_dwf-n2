...
<div class="main-container">
  ...
  `,e.appendChild(i),a.pcMove*a.userMove){case 12:case 5:o("win","Ganaste");break;case 4:case 10:case 18:o("draw","Empate");break;case 6:case 8:case 15:o("lose","Perdiste")}document.getElementById("again-button").addEventListener("click",()=>{t.goTo("/inicio")})}else t.goTo("/inicio")}}];var h={};h=new URL("green-star.4b96d87d.svg",import.meta.url).toString();var g={};g=new URL("red-star.342a139d.svg",import.meta.url).toString();var v={};v=new URL("yellow-star.cb78cc31.svg",import.meta.url).toString();var _={};_=new URL("ellipse.1fcd968b.svg",import.meta.url).toString(),function(){class e extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){let e=new URL(c),t=new URL(l),o=new URL(d);this.shadow.innerHTML=`
      ...
      * {
      ...
      `,this.shadow.appendChild(t)}}customElements.define("button-ce",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){let e=new URL(h),t=new URL(g),o=new URL(v);this.shadow.innerHTML=`
      ...
      * {
      ...
      `,this.shadow.appendChild(s)}}customElements.define("result-star-ce",e)}(),function(){class e extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.render()}render(){let e=this.textContent;console.log(e);let t=new URL(_);this.shadow.innerHTML=`
      ...
      * {
      ...
      `,this.shadow.appendChild(o)}}customElements.define("counter-ce",e)}(),function(e){function t(e){let t=u()?p+e:e;history.pushState({},"",t),o(t)}function o(o){let s=u()?o.replace(p,""):o;for(let o of m)o.path.test(s)&&o.component(e,{goTo:t})}"/"==location.pathname||"/desafio-piedra-papel-tijeras_dwf-n2/"==location.pathname?t("/inicio"):o(location.pathname),window.onpopstate=function(){o(location.pathname)}}(document.querySelector("body"));
//# sourceMappingURL=index.b6b55406.js.map
